...
/***/ "./apps/product/src/database/database.module.ts":
/*!******************************************************!*\
  !*** ./apps/product/src/database/database.module.ts ***!
  \******************************************************/
...
const product_service_1 = __webpack_require__(/*! ./product.service */ "./apps/product/src/product.service.ts");
const database_module_1 = __webpack_require__(/*! ./database/database.module */ "./apps/product/src/database/database.module.ts");
...
async function bootstrap() {
    const app = await core_1.NestFactory.createMicroservice(product_module_1.ProductModule, {
        ...
        options: {
            ...
            queue: common_1.QUEUES.PRODUCT_QUEUE,
            queueOptions: {
                durable: false
            },
        },
